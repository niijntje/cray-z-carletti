...
public class Validering
{
	...
	/**
	 * @param calendarString i formatet YYYY-MM-DD-HH:MM
	 * @return
	 * @author Rita Holst Jacobsen
	 */
	public static GregorianCalendar stringTilCalendar(String cS){
		GregorianCalendar gCal = new GregorianCalendar();
		gCal.set(Integer.parseInt(cS.substring(0,3)), Integer.parseInt(cS.substring(5,7))-1, Integer.parseInt(cS.substring(8,10)), Integer.parseInt(cS.substring(11,13)), Integer.parseInt(cS.substring(14,16)));
		return gCal;
	}

...
public class Opg2c extends JFrame {
	...
	/**
	 * S¾tter tekstfelterne txtMintrrtid og txtMaxtrretid 
	 * Samlet mint¿rretid og maxt¿rretid beregnes pŒ den givne mellemvare
	 * Metoden oprette ogsŒ forbindelse til databasen og lukker den igen

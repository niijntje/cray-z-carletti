...
public class SubFrameTilfoejMellemvarer extends JFrame implements Observer{
	...
	public SubFrameTilfoejMellemvarer(MainFrame mainFrame){
		...
		gridBagLayout.rowHeights = new int[]{0, 0, 0, 0, 0, 154, 49, 0};
		...
		JComboBox cbxProdukttype = new JComboBox();
		GridBagConstraints gbc_cbxProdukttype = new GridBagConstraints();
		gbc_cbxProdukttype.gridwidth = 2;
		gbc_cbxProdukttype.fill = GridBagConstraints.HORIZONTAL;
		gbc_cbxProdukttype.insets = new Insets(0, 0, 5, 5);
		gbc_cbxProdukttype.gridx = 3;
		gbc_cbxProdukttype.gridy = 2;
		getContentPane().add(cbxProdukttype, gbc_cbxProdukttype);
		cBoxModel.addElement(Service.getInstance().getProdukttyper());
		cbxProdukttype.setModel(cBoxModel);

...
public class ObjectCreater {
	...
	public void createSomeObjects() {
		...
		Delbehandling kortDelbehandling = Service.getInstance().opretToerring("Ultrakort t퓊ring", kortBehandling, Validering.varighedStringTilMillisekunder("00-00:01"), Validering.varighedStringTilMillisekunder("00-00:02"), Validering.varighedStringTilMillisekunder("00-00:03"), -1);
		...
		Delbehandling kortDelbehandling3 = Service.getInstance().opretToerring("Ultrakort t퓊ring", kortBehandling, Validering.varighedStringTilMillisekunder("00-00:01"), Validering.varighedStringTilMillisekunder("00-00:02"), Validering.varighedStringTilMillisekunder("00-00:03"),-1);
		...
		Mellemvare m3 = new Mellemvare("21312", hurtigProdukttype, pa3, cal); //<---Kan ikke kaldes gennem Service, da varianter hvor tidspunkt kan s푪tes i konstruktoren.

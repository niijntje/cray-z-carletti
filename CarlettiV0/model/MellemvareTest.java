...
public class MellemvareTest {
	...
	public void setUp() throws Exception {
		...
		Behandling behandling1 = Service.getInstance().opretBehandling(
				"Behandling A");
		Delbehandling delbehandling1 = Service.getInstance().opretToerring(
		...
		Delbehandling delbehandling2 = Service.getInstance().opretDragering(
		...
		starttid1.setTimeInMillis(System.currentTimeMillis()
				- Validering.varighedStringTilMillisekunder("02-04:00")); // Starttid
																			// s¾ttes
																			// til
																			// 2
																			// d.,
																			...
																			// nuv¾rende
																			// systemtid
		mellemvare1.addTidspunkt(starttid1); // <--Dette 'snyder' systemet, da
												// det aldrig benytter andet end
		...
		Behandling behandling4 = Service.getInstance().opretBehandling(
				"Behandling A");
		Delbehandling delbehandling3 = Service.getInstance().opretDragering(
				"Dragering 4", behandling4,
				Validering.varighedStringTilMillisekunder("00-04:00"), -1);
		Delbehandling delbehandling4 = Service.getInstance().opretToerring(
				"T¿rring 4", behandling4,
				Validering.varighedStringTilMillisekunder("02-01:00"),
				Validering.varighedStringTilMillisekunder("02-03:30"),
				Validering.varighedStringTilMillisekunder("02-07:00"), -1);
		Produkttype produkttype4 = Service.getInstance().opretProdukttype(
				"Produkttype X", "X's beskrivelse", behandling4);
		mellemvare4 = Service.getInstance().opretMellemvare("456",
				produkttype4, palle1);
		...
		// ----------Test#5-----------//
		mellemvare5 = Service.getInstance().opretMellemvare("456",
				produkttype4, palle1);
		mellemvare5.goToNextDelbehandling(); // <--SŒ mellemvaren er nu i gang
												// med sidste delbehandling i
												// behandlingen
		...
		// ----------Test#6-----------//
		mellemvare6 = Service.getInstance().opretMellemvare("123",
				produkttype1, palle1);
		...
		// ----------Test#7-----------//
		mellemvare7 = Service.getInstance().opretMellemvare("123",
				produkttype1, palle1);
		...
		produkttype11 = Service.getInstance().opretProdukttype("Lakridspinde",
				"", behandling11);
		produkttype12 = Service.getInstance().opretProdukttype(
				"Chokoladecrunch", "", behandling11);
		delbehandling11 = Service.getInstance().opretDragering("Dragering1",
				behandling11, 123214, -1);
		delbehandling12 = Service.getInstance().opretToerring("T¿rring1",
				behandling11, 12132132, 231232123, 243123122, -1);
		mellemvare11 = Service.getInstance().opretMellemvare("123",
				produkttype11, palle1);

		// ----------Test#15-----------//
		mellemvare15 = Service.getInstance().opretMellemvare("231223",
				produkttype11, palle1);
		mellemvare15.setIgangvaerendeDelbehandling(null);

		// ----------Test#17----------//
		Behandling behandling17 = Service.getInstance().opretBehandling("B11");
		produkttype17 = Service.getInstance().opretProdukttype("Lakridspinde",
				"", behandling11);
		produkttype18 = Service.getInstance().opretProdukttype(
				"Chokoladecrunch", "", behandling11);
		delbehandling17 = Service.getInstance().opretDragering("Dragering1",
				behandling11, 123214, -1);
		delbehandling18 = Service.getInstance().opretToerring("T¿rring1",
				behandling11, 12132132, 231232123, 243123122, -1);
		mellemvare17 = Service.getInstance().opretMellemvare("123",
				produkttype11, palle1);
	...
	public final void testNaesteDelbehandlingGyldig() {
		...
		// ----------Test#2-----------//
		assertFalse(Service.getInstance().naesteDelbehandlingGyldig(
				mellemvare2, DelbehandlingsType.DRAGERING));
		// ----------Test#3-----------//
		assertFalse(Service.getInstance().naesteDelbehandlingGyldig(
				mellemvare3, DelbehandlingsType.DRAGERING));
		// ----------Test#4-----------//
		assertTrue(Service.getInstance().naesteDelbehandlingGyldig(mellemvare4,
				DelbehandlingsType.TOERRING));
		// ----------Test#5-----------//
		assertTrue(Service.getInstance().naesteDelbehandlingGyldig(mellemvare5,
				null));
		// ----------Test#6-----------//
		assertFalse(Service.getInstance().naesteDelbehandlingGyldig(
				mellemvare6, DelbehandlingsType.TOERRING));
		// ----------Test#7-----------//
		assertFalse(Service.getInstance().naesteDelbehandlingGyldig(
				mellemvare7, DelbehandlingsType.DRAGERING));
		// ----------Test#------------//
